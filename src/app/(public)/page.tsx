...
const totalDoctors = doctorsRes.count ?? 0
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', background: '#fffdfc', minHeight: '100vh', color: '#221a19' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', padding: '64px 40px 40px', background: '#fff8f6' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1.05fr 0.95fr', gap: 56, alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 420 }}>
            ...
            <div style={{ position: 'absolute', top: 14, left: 0, background: '#ffffff', border: '1px solid #f0dfdc', borderRadius: 14, padding: '10px 14px', display: 'flex', alignItems: 'center', gap: 8, animation: 'floatY 5s ease-in-out infinite' }}>
            ...
            <div style={{ position: 'absolute', bottom: 26, right: -6, background: '#ffffff', border: '1px solid #f0dfdc', borderRadius: 14, padding: '10px 14px', display: 'flex', alignItems: 'center', gap: 8, animation: 'floatY 6s ease-in-out 1s infinite' }}>
      ...
      {/* Academic Years */}
      <section id="years" style={{ padding: '40px 40px 60px', background: '#fffdfc' }}>
